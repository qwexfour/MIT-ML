...
def make_polynomial_feature_fun(order):
  ...
  where k = sum_{i = 0}^order multichoose(d, i) (the number of all possible
  terms in the polynomial feature or order 'order').
  '''
  def f(raw_features):
